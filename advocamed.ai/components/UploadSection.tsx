      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 border border-gray-100">
        ...
        <div className="bg-blue-50 p-6 rounded-xl mb-8 text-left border border-blue-100">
            <h3 className="text-md font-semibold text-blue-900 mb-3 flex items-center">
                ...
                Optional: Check Charity Care Eligibility
            </h3>
            ...
            <p className="text-xs text-blue-600 mt-2">
                Providing this helps our AI determine if you qualify for mandatory non-profit hospital discounts (IRS 501r).
            </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <label className="flex-1 flex flex-col items-center justify-center h-48 border-2 border-primary border-dashed rounded-lg cursor-pointer bg-red-50 hover:bg-red-100 transition-colors group relative overflow-hidden">
                <div className="flex flex-col items-center justify-center z-10">
                    ...
                    <p className="text-xs text-gray-500">Scan Receipt Directly</p>
                </div>
                <input 
                    type="file" 
                    className="hidden" 
